...
public class IssuedBooksController {
    ...
    public IssuedBooks issueABook(@RequestBody IssuedBooks issuedBooks) {
        try {
            return issuedBooksService.issueABook(issuedBooks);
        } catch (Exception e) {
    ...
    public List<IssuedBooks> issuedBooksByUser(@RequestParam(value="userId") int userId) {
